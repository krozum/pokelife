                ...
                if (data['list'] != undefined) {
                    ...
                    $.each(messages, function(key, value) {
                        if (value['false_login'] == "bot") {
                            ...
                            $("#bot_list").append('<li style="word-break: break-word;padding: 1px 5px 1px 5px;font-family: Georgia, \'Times New Roman\', Times, serif; font-size: 14px; ' + (value["message"].indexOf(window.localStorage.falseLogin) >= 0 ? "background: #fba7a7b3; border-radius: 3px;" : "") + '"><span class="shout_post_date">(' + value["creation_date"].split(" ")[1] + ') </span><span class="shout_post_name2" style="cursor: pointer">'+(value["false_login"] == "Lew" ? '<img src="https://lh3.googleusercontent.com/proxy/IdYpD3-fpioCO9EgsvoYJxG5UNYTWjMSe0VZQfZMgyvJ6-eDf3me2CUoLVhBNxWE3-x5-4-F1KFhZWGSfCNbEs81hQEB750L" style=" width: 15px; margin-right: 1px; ">': "") + value["false_login"] + '</span>: ' + value["message"] + '</li>');
                        }
