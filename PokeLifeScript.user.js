...
//                 if(this.find(".panel-body ").lenght > 0){
//                     AutoGo.przerwij();
//                 }
            })
        }
    ...
    function initTutorial(){
        ...
        function show(){
            now = 0;
            slides = [];
            slides[0] = '<h4 style=" line-height: 23px; ">Witamy w Team Rocket, </h4><h5 style=" line-height: 23px; "> cieszymy sie ze zdecydowałes sie dołączyć do tego zacnego grona. <br><br>Oprowadzimy cię po wszystkich dodatkowych funkcjach które będziesz posiadał dzięki <b>PokeLifeScript</b><br><br>W razie problemów z dodatkiem lub sugestii dotyczących nowych funkcjonalności zapraszamy do naszej siedziby pod adresem: <br><a style=" color: #337ab7 !important; " href="https://github.com/krozum/pokelife/issues">https://github.com/krozum/pokelife/issues</a></h5>';
            slides[1] = '<h5 style=" line-height: 23px; ">W lewym górnym rogu masz wybór pokemona, dziczy i balli których AutoGo będzie uzywał do automatycznego klikania w dzicz.<br><img style="max-width: 100%" src="https://i.imgur.com/heZSnvB.png"/><br><br>Możesz wybrać z kilku rodzajów balli jak i łączonych konfiguracji gdzie w zależności który ball będzie najlepszy na danego pokemona taki zostanie użyty.<br><img src="https://i.imgur.com/4vaqXRr.png"/><br><br>Wybierając koło zębate jako pokemona możesz zdefiniować aby był używany różny pokemon w zależności od poziomu przeciwnika. Aby skonfigurować tą opcje wybierz koło zębate w prawym górnym rogu.<br><img style="max-width: 100%" src="https://i.imgur.com/chPrxcr.png"/><img style="max-width: 100%" src="https://i.imgur.com/67e5fHL.png"></h5>';
